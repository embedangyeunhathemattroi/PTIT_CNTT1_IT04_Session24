...
class Screening {
    ...
    public movie: Movie;      // Đối tượng phim
    public time: string;      // Giờ chiếu
    public price: number;     // Giá vé

    constructor(id: number, movie: Movie, time: string, price: number) {
        this.id = id;
        this.movie = movie;
        this.time = time;
        this.price = price;
...
// =======================
class Cinema {
    public name: string;              // Tên rạp
    public screenings: Screening[];   // Danh sách suất chiếu
